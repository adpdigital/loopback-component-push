 ...
 * @return {Number} Index of added trackId
 */
PushManager.prototype.addToCancelled = function(trackId) {
  return trackId && CANCELLED_PUSH.push(trackId);
};
...
PushManager.prototype.isCancelled = function(notification) {
  return notification && notification.trackId && CANCELLED_PUSH.includes(notification.trackId);
};
