...
function GcmCcsProvider(pushManager, app, pushSettings) {
...
GcmCcsProvider.prototype.pushNotification = function(notification, deviceToken, installation, cb) {
  var self = this;
  var targets = [];
  ...
  targets.map( function(token){
    ...
    var xcs_message = new Message(notification.messageId + ':' + notification.deviceId + ':' + (++self.counter))
      ...
      .addData('groupId', notification.groupId);
